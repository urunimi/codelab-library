...
public abstract class WorkerService extends BaseService {
	 ...
	 * @see codelab.library.service.BaseService#handleStart(android.content.Intent, int)
	 */
	@Override
	 ...
	 * @see codelab.library.service.BaseService#onWorkerRequest(android.os.Message)
	 */
	@Override
