package com.codelab.library.concurrent;
...
import com.codelab.library.constant.DebugConfig;
import com.codelab.library.constant.ThreadConfig;
import com.codelab.library.log.LogByCodeLab;
...
public class ThreadHost {
	 ...
	 * @param guest 대기시킬 대상
	 */
	synchronized static final void offer(final ThreadGuest guest) {
		if (guest == null) {
	 ...
	 */
	private static final RunnableGuest makeRunnable(final long offerTime, final ThreadGuest guest) {
