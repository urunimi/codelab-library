package com.codelab.library.service;
...
import com.codelab.library.app.PermissionManager;
...
public abstract class WorkerService extends BaseService {
	 ...
	 * @see com.codelab.library.service.BaseService#handleStart(android.content.Intent, int)
	 */
	@Override
	 ...
	 * @see com.codelab.library.service.BaseService#onWorkerRequest(android.os.Message)
	 */
	@Override
