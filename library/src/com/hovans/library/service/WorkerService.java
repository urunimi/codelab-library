package com.hovans.library.service;
...
import com.hovans.library.app.PermissionManager;
import com.hovans.library.log.LogByCodeLab;
...
public abstract class WorkerService extends BaseService {
	 ...
	 * @see com.hovans.library.service.BaseService#handleStart(android.content.Intent, int)
	 */
	@Override
	 ...
	 * @see com.hovans.library.service.BaseService#onWorkerRequest(android.os.Message)
	 */
	@Override
