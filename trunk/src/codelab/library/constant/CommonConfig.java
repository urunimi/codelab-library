		...
		try {
			...
			if (context != null) {
				...
				for (Signature sig : sigs) {
					...
					switch (sum) {
					case HASH_DEBUG:
						System.out.println("codelab.library.constant.CommonConfig.isDebugVersion(): Debug Version.");// + sum);
						calculatedVersionInfo = VERSION_DEBUG;
						return calculatedVersionInfo;
					case HASH_BETA:
						System.out.println("codelab.library.constant.CommonConfig.isDebugVersion(): Beta Version.");// + sum);
						calculatedVersionInfo = VERSION_BETA;
						return calculatedVersionInfo;
					default:
						System.out.println("codelab.library.constant.CommonConfig.isDebugVersion(): Release Version.");// + sum);
